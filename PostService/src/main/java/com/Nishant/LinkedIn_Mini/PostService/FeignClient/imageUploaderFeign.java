...
// ADD THIS: consumes = MediaType.MULTIPART_FORM_DATA_VALUE
    ...
    ResponseEntity<ApiResponse<CreatePostUploaderResponseDto>> upload(@RequestPart("file") MultipartFile file);

    // 2. Image Delete Endpoint
    @DeleteMapping("/upload/file/delete")
    ResponseEntity<ApiResponse<DeleteImageResponseDto>> deleteImage(@RequestBody DeleteImageRequestDto request);
}
